  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        A: common_vendor.o(($event) => _ctx.$onAliGetAuthorize(getUserPhoneNumberByWx, $event)),
        B: common_vendor.o(($event) => _ctx.$onAliAuthError(getUserPhoneNumberByWx, $event)),
        C: !common_vendor.unref(isBinding) && common_vendor.unref(isLogIn),
        D: common_vendor.p({
          type: "compose",
          size: "26"
        }),
        E: common_vendor.o(getUserPhoneNumberByAli),
        F: common_vendor.o((...args) => _ctx.getUserPhoneNumberByAliError && _ctx.getUserPhoneNumberByAliError(...args)),
        G: !common_vendor.unref(isBinding) && common_vendor.unref(isLogIn),
        H: common_vendor.o(userLogin),
        I: !common_vendor.unref(isLogIn)
      };
    };
  }
};
